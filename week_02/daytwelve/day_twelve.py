"""
Python Learning Journey - Day Twelve
Date: October 3, 2025
Author: Cosmas Onyekwelu
Topic - Comprehensive Function and Error Handling Concepts
"""
...
class FunctionFundamentals:
    ...
    def demonstrate_function_basics(self):
        ...
        print(
            f"Circle with radius 5: Area={area:.2f}, Circumference={circ:.2f}")
    ...
    def demonstrate_parameter_types(self):
        ...
        # Keyword arguments
        print(
            f"Keyword args: {describe_pet(pet_name='Whiskers', animal_type='cat')}")
        ...
        print(
            f"Arbitrary args: {make_pizza('pepperoni', 'mushrooms', 'cheese')}")
        ...
        user_profile = build_profile(
            'John', 'Doe', age=30, city='NYC', occupation='Engineer')
    ...
    def demonstrate_custom_exceptions(self):
        ...
        class NegativeNumberError(CalculatorError):
            def __init__(self, operation, value):
                super().__init__(
                    f"Cannot perform {operation} on negative number: {value}")

        class InvalidInputError(CalculatorError):
            def __init__(self, input_value, expected_type):
                super().__init__(
                    f"Invalid input: {input_value}. Expected {expected_type}")
