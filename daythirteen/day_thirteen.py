"""
Python Learning Journey - Day Thirteen
Date: October 4, 2025
Author: Cosmas Onyekwelu
Topic: Introduction to Object-Oriented Programming:  Classes, Objects, and OOP Fundamentals
"""
    ...
    def demonstrate_class_attributes(self):
        ...
        class Bank:
            ...
            def __init__(self, account_holder, initial_balance=0):
                ...
                print(
                    f"Created account {self.account_number} for {account_holder}")
