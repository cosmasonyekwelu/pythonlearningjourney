...
Python Learning Journey - Building Class Hierarchies and Flexible Code Structures
"""
...
class InheritanceFundamentals:
    ...
    def demonstrate_multiple_inheritance(self):
        ...
        print(f"\nInheritance checks:")
        print(f"Is HybridVehicle subclass of Engine? {issubclass(HybridVehicle, Engine)}")
        print(f"Is HybridVehicle subclass of ElectricSystem? {issubclass(HybridVehicle, ElectricSystem)}")
        print(f"Is hybrid_car instance of Engine? {isinstance(hybrid_car, Engine)}")
        print(f"Is hybrid_car instance of ElectricSystem? {isinstance(hybrid_car, ElectricSystem)}")
...
class VehicleHierarchyProject:
    ...
    def create_vehicle_hierarchy(self):
        ...
        sports_car = SportsCar("Porsche", "911", 2024, "Premium Gasoline", 2, 2, 182)
        ...
        def operate_vehicle(vehicle):
            ...
            if isinstance(vehicle, Motorcycle):
                ...
                print(f"  {vehicle.start_engine()}")  # Try again after raising kickstand
            elif isinstance(vehicle, SportsCar):
                print(f"  {vehicle.enable_sports_mode()}")
                print(f"  {vehicle.start_engine()}")  # Try again with sports mode
